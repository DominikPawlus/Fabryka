            ...
            case 1: {
                ...
                case 3: {
                    ...
                    switch (K) {
                        ...
                        case (1): {
                            Office::registerVehicle(cars.at(findVehicle<Car>(*loadCarData(W, plik), cars)), plik);
                            break;
                        }
                        case (2): {
                            Office::registerVehicle(motorcycles.at(findVehicle<Motorcycle>(*loadMotorData(W, plik), motorcycles)),plik);
                            break;
                        }
                        default: {
                            break;
                ...
                case 4: {
                    ...
                    switch (K) {
                        ...
                        case (1): {
                            ...
                            cars.at(findNumber<Car>(cars, number)).go(km);
                        ...
                        case (2): {
                            ...
                            motorcycles.at(findNumber<Motorcycle>(motorcycles, number)).go(km);
                        ...
                        case (3): {
                            ...
                            bikes.at(findVehicle<Bike>(*tmp, bikes)).go(km);
                ...
                case 7: {
                    ...
                    switch (K) {
                        ...
                        case (1): {
                            ...
                            Varnisher<Car>::changeColor(cars.at(findNumber<Car>(cars, number)), plik);
                        ...
                        case (2): {
                            ...
                            Varnisher<Motorcycle>::changeColor(motorcycles.at(findNumber<Motorcycle>(motorcycles, number)), plik);
